export default function LogsPage() {
  return (
    <div className="p-10 max-w-6xl mx-auto">
      ...
      <p className="text-slate-500 font-medium mt-1">Immutable system access and activity history.</p>
      
      <div className="mt-10 bg-white rounded-2xl shadow-sm border border-slate-200 p-10 text-center">
        <p className="text-slate-500 font-medium text-lg">System audit log UI will be enabled in the production release.</p>
